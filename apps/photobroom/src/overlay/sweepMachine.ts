...
export function reducer(state: State, action: Action): State {
  switch (action.type) {
    ...
    case "collected": {
      ...
      if (all.length === 0) {
        return {
          ...
          view: {
            phase: "error",
            message: "No photos found on this page. Open a search/date first, then sweep.",
          },
        };
      }
      ...
      return {
        ...state,
        view: { phase: "sweeping", deck: newDeck(fresh, all.length - fresh.length), dir: 1 },
      };
    }
    ...
    case "sweepAll":
      ...
      return {
        ...state,
        view: { phase: "sweeping", deck: newDeck(state.view.collected, 0), dir: 1 },
      };
    ...
    case "undo": {
      ...
      return {
        ...state,
        view: { phase: "sweeping", deck: { ...deck, decisions, index }, dir: -1 },
      };
    }
